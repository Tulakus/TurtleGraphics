...
let aboutContent = [
    ...
    'in which commands for movement and drawing produced line graphics',
    ' - see more information about Logo language on' ,
    a({href: 'https://en.wikipedia.org/wiki/Logo_(programming_language)', title: 'WIKI'}), 
    br, br,
    {tag: 'h4', children: 'How to begin'},
    'Type commands which can help your turtle draw objects on the canvas ands press button Draw it too see it. ',
    'If lines are typed correctly, the turtle will draw desired picture. ',
    'The turtle will remember typed commands which can later be found in History of commands section,',
    ' from where they can reloaded into Commands editor field. ',
    'See section Examples for inspiration.', br, br,
...
let commands = [
    ...
    },
    {
        command: 'pu',
        description: [
                'Turtle’s movement will not leave a line behind', 
                br,
                'Note: Do not forget to use command pd for putting down a pencil again'
            ],
        example: 'pu'
    },
    {
    ...
    },
    {
        command: 'pcolor',
        description: [
                'It changes a color of a drawn line. A colour is defined by a name. List of supported colours: ',
                a({href: 'http://www.w3schools.com/colors/colors_names.asp', title: 'barev'})
             ],
        example: 'pcolor red'
    },
    {
