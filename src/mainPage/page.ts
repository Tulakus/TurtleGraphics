      ...
      me.children = [
        ...
        b.styledDiv(
          [
              ...
              [
                b.styledDiv(
                  [
                    ...
                    b.style(
                      editor({ onChange: parseAndCheckCommand, command: state.command, }),
                      {height: 'calc(265px - 43px)', overflowY: 'auto'}
                    ),
                  ],
                ...
                b.styledDiv(
                  [
                    ...
                    b.styledDiv(
                      ...
                      {width: '100%', overflowY: 'auto', backgroundColor: 'gray', height: 'calc(100% - 39px)', top: 0}
                    )
                  ],
            ...
            ctx.isModalVisible && helpModalContainer(
              {
                onClose: () => {
                  ctx.isModalVisible = false;
                  b.invalidate();
